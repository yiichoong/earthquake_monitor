CREATE TABLE IF NOT EXISTS usgs.ref_earthquake_magnitude_type (
	id SERIAL PRIMARY KEY
	, magnitude_type VARCHAR(80)
	, magnitude_range VARCHAR(50)
...
INSERT INTO usgs.ref_earthquake_magnitude_type 
	(magnitude_type, magnitude_range, distance_range, equation, comments)
VALUES
(
	'Mww (Moment W-phase)(generic notation Mw)', 
	'~5.0 and larger', 
	'1 - 90  degrees', 
	'MW = 2/3 * (log10(MO) - 16.1), where MO is the seismic moment.  Note this is also unit-dependent; the formula above is for moment in dyne-cm. If using metric units (N.m), the constant is 9.1.', 
...
(
	...
	'~5.5 and larger',
	'20 - 180  degrees',
	'MW = 2/3 * (log10(MO) - 16.1), where MO is the seismic moment.',
...
(
	...
	'~4.0 to ~6.5',
	'15 - 100 degrees',
	'mb = log10(A/T) + Q(D,h) , where A is the amplitude of ground motion (in microns); T is the corresponding period (in seconds); and Q(D,h) is a correction factor that is a function of distance, D(degrees), between epicenter and station and focal depth, h (in kilometers), of the earthquake.', 
...
(
	'mb_Lg, mb_lg, or MLg  (short-period surface wave)',
	'~3.5 to ~7.0',
...
(
	...
	'~3.5 and larger',
	'all',
	'Me = 2/3 log10E - 2.9, where E is the energy calculated by log10E = 11.8 + 1.5MS where energy, E, is expressed in ergs, and Ms is the surface wave magnitude.',
...
SELECT * FROM usgs.ref_earthquake_magnitude_type remt;
